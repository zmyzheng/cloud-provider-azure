...
* `mcr.microsoft.com/oss/kubernetes/azure-cloud-controller-manager:v1.24.2`
* `mcr.microsoft.com/oss/kubernetes/azure-cloud-node-manager:v1.24.2`
...
|--------------------|------------------------|-----------------------|
| master             | N/A                    | master                |
| v1.24.x            | v1.24.2                | release-1.24          |
| v1.23.x            | v1.23.14               | release-1.23          |
| v1.22.x            | v1.1.17                | release-1.1           |
| v1.21.x            | v1.0.21                | release-1.0           |
...
Note: each new version update may take around 2 weeks to be deployed to all prod regions.

| AKS version        | cloud-controller-manager version | cloud-node-manager version |
|--------------------|----------------------------------|----------------------------|
| v1.24.x (preview)  | v1.24.2                          | v1.23.11                   |
| v1.23.x            | v1.23.14              　　　　　　| v1.23.11                   |
| v1.22.x            | v1.1.17                          | v1.1.14                    |
| v1.21.x            | v1.0.21                          | v1.0.18                    |
